...
Historical names such as `your-api-source` and `codex-provider-routing` are
retained only in the migration registry for lookup; their one-release
compatibility skill entries have been retired. Provider-specific endpoint and

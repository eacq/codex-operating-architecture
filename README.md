...
- Version: `1.13.0.0`
- Channel: `Private` / 私有
- Release note: [docs/release-notes/v1.13.0.0.md](docs/release-notes/v1.13.0.0.md)
- Highlights: Release documentation, Skill architecture
- Visual: [docs/assets/release-visual-highlights-labeled.png](docs/assets/release-visual-highlights-labeled.png)
- README optimization: audited with github-readme-presentation; provenance: [docs/release-readme-audits/v1.13.0.0.json](docs/release-readme-audits/v1.13.0.0.json)

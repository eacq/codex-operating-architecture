...
- Version: `1.9.0.0`
- Channel: `Private` / 私有
- Release note: [docs/release-notes/v1.9.0.0.md](docs/release-notes/v1.9.0.0.md)
...
- README optimization: audited with github-readme-presentation; provenance: [docs/release-readme-audits/v1.9.0.0.json](docs/release-readme-audits/v1.9.0.0.json)

...
foreach ($asset in @('docs/assets/readme-collaboration-loop.png','docs/assets/readme-collaboration-loop-labeled.png','docs/assets/readme-architecture-overview.png','docs/assets/file-organization-architecture.png')) {
...
$requirements = @{
    'README.md' = @("## $zhStart","## $zhLoop",'docs/assets/readme-collaboration-loop.png','docs/assets/readme-architecture-overview.png');
    'README.en.md' = @('## Start here','## How it works','docs/assets/readme-collaboration-loop.png','docs/assets/readme-architecture-overview.png')
}

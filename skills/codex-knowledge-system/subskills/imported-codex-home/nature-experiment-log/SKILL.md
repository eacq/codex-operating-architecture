---
name: imported-nature-experiment-log
description: Internal compatibility package for the migrated Codex Home skill 'nature-experiment-log'. Route through codex-knowledge-system; this package is not a top-level discovery interface.
---

---
name: imported-notion-knowledge-capture
description: Internal compatibility package for the migrated Codex Home skill 'notion-knowledge-capture'. Route through codex-knowledge-system; this package is not a top-level discovery interface.
---

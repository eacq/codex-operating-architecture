---
name: imported-zotero-management
description: Internal compatibility package for the migrated Codex Home skill 'zotero-management'. Route through codex-knowledge-system; this package is not a top-level discovery interface.
---

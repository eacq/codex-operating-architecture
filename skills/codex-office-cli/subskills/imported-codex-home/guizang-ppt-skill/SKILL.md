---
name: imported-guizang-ppt-skill
description: Internal compatibility package for the migrated Codex Home skill 'guizang-ppt-skill'. Route through codex-office-cli; this package is not a top-level discovery interface.
---

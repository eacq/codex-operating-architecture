---
name: imported-systematic-debugging
description: Internal compatibility package for the migrated Codex Home skill 'systematic-debugging'. Route through codex-error-feedback; this package is not a top-level discovery interface.
---

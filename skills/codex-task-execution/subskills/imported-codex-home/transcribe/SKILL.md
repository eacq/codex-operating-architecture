---
name: imported-transcribe
description: Internal compatibility package for the migrated Codex Home skill 'transcribe'. Route through codex-task-execution; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: transcribe

**Owner:** $(@{Name=transcribe; Owner=codex-task-execution; Source=C:\Users\12484\.codex\skills\transcribe}.Owner)  

---
name: imported-jupyter-notebook
description: Internal compatibility package for the migrated Codex Home skill 'jupyter-notebook'. Route through codex-task-execution; this package is not a top-level discovery interface.
---

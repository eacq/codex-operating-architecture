---
name: imported-caveman
description: Internal compatibility package for the migrated Codex Home skill 'caveman'. Route through codex-task-execution; this package is not a top-level discovery interface.
---

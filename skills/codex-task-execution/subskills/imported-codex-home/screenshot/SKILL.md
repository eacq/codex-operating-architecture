---
name: imported-screenshot
description: Internal compatibility package for the migrated Codex Home skill 'screenshot'. Route through codex-task-execution; this package is not a top-level discovery interface.
---

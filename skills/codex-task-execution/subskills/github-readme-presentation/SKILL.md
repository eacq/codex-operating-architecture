...
description: Owner-internal README presentation workflow for evidence-grounded audits, redesigns, and bounded asset updates before publication.
---
...
local Global Experience Agent, and model. Use **README** mode when the document is a

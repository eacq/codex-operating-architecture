---
name: imported-hatch-pet
description: Internal compatibility package for the migrated Codex Home skill 'hatch-pet'. Route through codex-image-workflow; this package is not a top-level discovery interface.
---

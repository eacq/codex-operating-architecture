---
name: imported-academic-figure-generation
description: Internal compatibility package for the migrated Codex Home skill 'academic-figure-generation'. Route through codex-image-workflow; this package is not a top-level discovery interface.
---

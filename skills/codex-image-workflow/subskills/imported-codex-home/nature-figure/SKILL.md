---
name: imported-nature-figure
description: Internal compatibility package for the migrated Codex Home skill 'nature-figure'. Route through codex-image-workflow; this package is not a top-level discovery interface.
---

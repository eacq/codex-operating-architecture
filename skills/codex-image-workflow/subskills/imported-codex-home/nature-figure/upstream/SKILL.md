...
name: nature-figure
description: >-
  Submission-grade Nature/high-impact journal figure workflow for Python or R, plus optional OpenRouter GPT Image 2 manuscript schematic generation when explicitly requested. Use to create, revise, audit, or polish manuscript figures, multi-panel scientific plots, figures4papers-style matplotlib plots, journal-ready SVG/PDF/TIFF outputs, graphical abstracts, concept schematics, mechanism diagrams, or paper schematic illustrations. Before plotting or image generation, define the figure conclusion, evidence logic, export needs, and review risks. For plotting, honor an explicit Python/R choice, otherwise reuse or ask once for the saved backend preference. For explicit AI schematics, use the AI-schematic route without asking Python/R. Supports matplotlib/seaborn, ggplot2/patchwork/ComplexHeatmap, and OpenRouter Images API drafts. Not for dashboards or Illustrator/Figma-first infographics.
metadata:
  imported:
    version: 2.0.0

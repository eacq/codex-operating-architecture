...
name: drawio-skill
version: 2.1.0
description: Create editable draw.io diagrams for architecture, workflows, UML, ERD, C4, BPMN, SysML, networks, and visual explanations; export PNG, SVG, PDF, or JPG through the local desktop CLI.
license: MIT

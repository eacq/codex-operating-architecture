---
name: imported-nature-reviewer
description: Internal compatibility package for the migrated Codex Home skill 'nature-reviewer'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: nature-reviewer

**Owner:** $(@{Name=nature-reviewer; Owner=codex-text-style; Source=C:\Users\12484\.codex\skills\nature-reviewer}.Owner)  

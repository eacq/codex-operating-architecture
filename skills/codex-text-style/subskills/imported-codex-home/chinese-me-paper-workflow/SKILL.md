---
name: imported-chinese-me-paper-workflow
description: Internal compatibility package for the migrated Codex Home skill 'chinese-me-paper-workflow'. Route through codex-text-style; this package is not a top-level discovery interface.
---

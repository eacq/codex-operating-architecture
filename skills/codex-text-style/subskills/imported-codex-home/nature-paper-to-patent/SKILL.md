---
name: imported-nature-paper-to-patent
description: Internal compatibility package for the migrated Codex Home skill 'nature-paper-to-patent'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: nature-paper-to-patent

**Owner:** $(@{Name=nature-paper-to-patent; Owner=codex-text-style; Source=C:\Users\12484\.codex\skills\nature-paper-to-patent}.Owner)  

---
name: imported-empirical-paper-workflow
description: Internal compatibility package for the migrated Codex Home skill 'empirical-paper-workflow'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: empirical-paper-workflow

**Owner:** $(@{Name=empirical-paper-workflow; Owner=codex-text-style; Source=%USERPROFILE%\.codex\skills\empirical-paper-workflow}.Owner)

---
name: imported-nature-polishing
description: Internal compatibility package for the migrated Codex Home skill 'nature-polishing'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: nature-polishing

**Owner:** $(@{Name=nature-polishing; Owner=codex-text-style; Source=C:\Users\12484\.codex\skills\nature-polishing}.Owner)  

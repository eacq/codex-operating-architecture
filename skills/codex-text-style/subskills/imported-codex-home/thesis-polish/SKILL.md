---
name: imported-thesis-polish
description: Internal compatibility package for the migrated Codex Home skill 'thesis-polish'. Route through codex-text-style; this package is not a top-level discovery interface.
---

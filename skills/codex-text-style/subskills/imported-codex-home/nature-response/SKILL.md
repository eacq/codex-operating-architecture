---
name: imported-nature-response
description: Internal compatibility package for the migrated Codex Home skill 'nature-response'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: nature-response

**Owner:** $(@{Name=nature-response; Owner=codex-text-style; Source=C:\Users\12484\.codex\skills\nature-response}.Owner)  

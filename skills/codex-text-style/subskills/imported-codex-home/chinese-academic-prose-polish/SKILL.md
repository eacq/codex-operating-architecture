---
name: imported-chinese-academic-prose-polish
description: Internal compatibility package for the migrated Codex Home skill 'chinese-academic-prose-polish'. Route through codex-text-style; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: chinese-academic-prose-polish

**Owner:** $(@{Name=chinese-academic-prose-polish; Owner=codex-text-style; Source=C:\Users\12484\.codex\skills\chinese-academic-prose-polish}.Owner)  

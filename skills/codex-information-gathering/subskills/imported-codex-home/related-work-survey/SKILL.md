---
name: imported-related-work-survey
description: Internal compatibility package for the migrated Codex Home skill 'related-work-survey'. Route through codex-information-gathering; this package is not a top-level discovery interface.
---

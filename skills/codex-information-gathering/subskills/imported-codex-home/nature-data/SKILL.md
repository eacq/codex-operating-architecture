---
name: imported-nature-data
description: Internal compatibility package for the migrated Codex Home skill 'nature-data'. Route through codex-information-gathering; this package is not a top-level discovery interface.
---

# Imported Codex Home Package: nature-data

**Owner:** $(@{Name=nature-data; Owner=codex-information-gathering; Source=%USERPROFILE%\.codex\skills\nature-data}.Owner)

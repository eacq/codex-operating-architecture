...
description: Owner-internal subskill for treating the global experience system as one coordinated system while preserving specialist owners.
---
...
Run when the user explicitly refers to the global experience system, or asks to
fuse, split, merge, refactor, encapsulate, streamline, or refine skill
knowledge and experience workflows as one architecture-level system.

## Boundary

The global experience system is the coordinated loop across these existing
owners:
...
Do not create a new top-level skill for this system unless at least two

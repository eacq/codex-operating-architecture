...
4. At Git milestones or completed iterations, reconcile project requirements, workflows, experience, retrospectives, pending events, state, and the metadata-only file-organization review. Route initialization and material follow-up organization checks through `codex-file-organization`; actual moves still require a user-approved manifest and off-root backup.

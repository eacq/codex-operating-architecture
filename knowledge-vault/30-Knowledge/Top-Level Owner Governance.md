...
`resource-economy` subskill. The later 2026-07-21 unit topology review retired
expired compatibility owners after their one-release windows passed and their
canonical replacements remained available. Migration records stay as historical
information units; retired compatibility folders are no longer top-level
functional units.

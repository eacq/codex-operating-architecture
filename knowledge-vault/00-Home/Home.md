...
type: index
status: active
source: codex-operating-architecture
verified: true
---
...
```mermaid
flowchart LR
    H[History and project evidence] --> E[Verified experience]
    E --> K[Linked knowledge]
    K --> W[Reusable workflows]
    K --> C[Codex local learning]
    K --> A[User Anki review]
    K --> M[MindMaster and Mermaid maps]
